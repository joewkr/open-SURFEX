...
if(${USE_LOCAL_NETCDF})
    ExternalProject_add(HDF5
        ...
        CMAKE_ARGS -DCMAKE_INSTALL_PREFIX:PATH=<INSTALL_DIR> -DHDF5_BUILD_FORTRAN=ON
        )
    ...
    ExternalProject_add(NetCDF_C
        ...
        INSTALL_DIR ${CMAKE_BINARY_DIR}/libs
        CMAKE_ARGS -DCMAKE_INSTALL_PREFIX:PATH=<INSTALL_DIR> -DENABLE_DAP=OFF
        )
...
if(${USE_LOCAL_GRIB_API})
    ExternalProject_add(grib_api
        ...
        INSTALL_DIR ${CMAKE_BINARY_DIR}/libs
        CMAKE_ARGS -DCMAKE_INSTALL_PREFIX:PATH=<INSTALL_DIR> -DENABLE_NETCDF=OFF -DENABLE_FORTRAN=ON  -DENABLE_PYTHON=OFF
        )
