...
INTERFACE WRITE_NETCDF
    MODULE PROCEDURE WRITE_NETCDF_CHARACTER_0D
    MODULE PROCEDURE WRITE_NETCDF_CHARACTER_1D
    MODULE PROCEDURE WRITE_NETCDF_INTEGER_0D
    MODULE PROCEDURE WRITE_NETCDF_INTEGER_1D
    MODULE PROCEDURE WRITE_NETCDF_INTEGER_2D
    MODULE PROCEDURE WRITE_NETCDF_REAL_0D
    MODULE PROCEDURE WRITE_NETCDF_REAL_1D
    MODULE PROCEDURE WRITE_NETCDF_REAL_2D
    MODULE PROCEDURE WRITE_NETCDF_REAL_3D
    MODULE PROCEDURE WRITE_NETCDF_REAL_1D_PART
    MODULE PROCEDURE WRITE_NETCDF_REAL_2D_PART
