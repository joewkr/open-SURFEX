...
!
    MODULE PROCEDURE VEG_HEIGHT_FROM_LAI_0D
    MODULE PROCEDURE VEG_HEIGHT_FROM_LAI_1D
    MODULE PROCEDURE VEG_HEIGHT_FROM_LAI_2D
    MODULE PROCEDURE VEG_HEIGHT_FROM_LAI_VEGTYPE
!
END INTERFACE
!
CONTAINS
