...
INTERFACE UNPACK_SAME_RANK
      MODULE PROCEDURE UNPACK_SAME_RANK_FROM1DI
      MODULE PROCEDURE UNPACK_SAME_RANK_FROM2DI
      MODULE PROCEDURE UNPACK_SAME_RANK_FROM1DL
      MODULE PROCEDURE UNPACK_SAME_RANK_FROM1D
      MODULE PROCEDURE UNPACK_SAME_RANK_FROM2D
      MODULE PROCEDURE UNPACK_SAME_RANK_FROM3D
      MODULE PROCEDURE UNPACK_SAME_RANK_FROM3DI
      MODULE PROCEDURE UNPACK_SAME_RANK_FROM4D
!
END INTERFACE
!
CONTAINS
