...
INTERFACE PACK_SAME_RANK
      MODULE PROCEDURE PACK_SAME_RANK_FROM1DI
      MODULE PROCEDURE PACK_SAME_RANK_FROM2DI
      MODULE PROCEDURE PACK_SAME_RANK_FROM3DI
      MODULE PROCEDURE PACK_SAME_RANK_FROM1DL
      MODULE PROCEDURE PACK_SAME_RANK_FROM1D
      MODULE PROCEDURE PACK_SAME_RANK_FROM2D
      MODULE PROCEDURE PACK_SAME_RANK_FROM3D
      MODULE PROCEDURE PACK_SAME_RANK_FROM4D
!
